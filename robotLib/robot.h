//
// Created by Charlie Wadds on 2024-02-26.
//
#include <stdint.h>
#include "Matrices.h"
#ifndef MULTIBODY_DYNAMICS_LG_C_ROBOT_H
#define MULTIBODY_DYNAMICS_LG_C_ROBOT_H

typedef struct link_s{
    uint8_t mass;//kg
    uint8_t length;//M
    matrix twist;//se(3) TODO this should be a 6x1 matrix of doubles [0,0,L,0,0,0]
    matrix CoM_twist;//se(3) TODO this should be a 6x1 matrix of doubles [0,0,L/2,0,0,0]
    uint8_t I;//[kg m2]   todo 1/12*m*L^2*eye(3);
    matrix M;//[kg;kg m2] todo [ m.*eye(3), zeros(3); zeros(3), I  ];
}link;
...
#endif //MULTIBODY_DYNAMICS_LG_C_ROBOT_H
